  ...
  for (var i = proposalCount; i >= 0; i--) {
    if (foundZero == false) {
      ...
      if (creationTime == 0 && proposer == '0x0000000000000000000000000000000000000000') {
        ...
        proposal['progress'] = getProgress(parseInt(proposal['yesVotes']), parseInt(proposal['noVotes'])) // calculate progress bar and passing/failing
...
function isPending(proposer, creationTime) {
  ...
  if (proposer != '0x0000000000000000000000000000000000000000' && creationTime == 0) {
    bool = true
  }
