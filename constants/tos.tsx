...
- Export, reexport, or transfer, directly or indirectly, any KaliCo technology in violation of applicable export laws or regulations;
...
- Use the Site in any manner that could interfere with, disrupt, negatively affect, or inhibit other users from fully enjoying the Site or the KaliCo protocol, or that could damage, disable, overburden, or impair the functioning of the Site or the KaliCo protocol in any manner;
- Attempt to circumvent any content filtering techniques or security measures that KaliCo employs on the Site, or attempt to access any service or area of the Site that you are not authorized to access;
...
- That any Smart Contracts you interact with are entirely your own responsibility and liability, and that KaliCo is not party to the Smart Contracts;
...
You agree to defend, indemnify and hold harmless KaliCo, its affiliates, licensors and service providers, and its and their respective officers, directors, employees, contractors, agents, licensors, suppliers, successors and assigns from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses or fees (including reasonable attorneys' fees) arising out of or relating to your violation of these Terms or your use of the Site, including.
...
Nothing included in the site constitutes an offer or solicitation to sell, or distribution of, investments and related services by KaliCo to anyone in any jurisdiction.
...
These Terms and the documents referred to in them set out the entire agreement between you and us with respect to your use of the site, KaliCo and the services provided via the site and supersede any and all prior or contemporaneous representations, communications or agreements (written or oral) made between you or us.
