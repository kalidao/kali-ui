      ...
      <Box>
        <Tabs defaultValue="token">
          ...
          <TabsContent value="token">
            {tokenBalance !== '' ? <Tokens tokenBalance={tokenBalance} /> : <Text>We are working on bringing Treasury support for your chain.</Text>}
          </TabsContent>
          <TabsContent value="nft">
            {nftBalance !== '' ? <NFTs nftBalance={nftBalance ? nftBalance['result'] : null} /> : <Text>We are working on bringing Treasury support for your chain.</Text>}
          </TabsContent>
        </Tabs>
      </Box>
    </Layout>
