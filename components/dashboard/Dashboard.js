...
import { Heading, Icon, HStack, Grid, Box, Spacer, useToast } from '@chakra-ui/react'
import Reload from '../elements/Reload.js'
import { BiGridAlt } from 'react-icons/bi'
import { fetchStaticInfo, fetchExtensions, fetchBalances, fetchRicardian } from '../../utils/fetchDaoInfo'
...
export default function Dashboard() {
  ...
  async function fetchData() {
    ...
    try {
      ...
      var { dao_ } = await fetchStaticInfo(instance, factory, address, web3, daoChain, account)
