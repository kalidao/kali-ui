...
export default function UserDAOs({ address }) {
  ...
  return (
    ...
    {daos.length > 1 ? <ResultsText> They are are in {daos.length} DAOs </ResultsText> : (daos.length === 1 ? <ResultsText>They are in {daos.length} DAO</ResultsText> : <ResultsText>They are not in any DAO!</ResultsText>)}
    <Results>
