import { Avatar, Card, Heading, Spinner, Stack, Stat } from '@kalidao/reality'
...
const Profile = () => {
  ...
  const { data, isLoading, isError, error } = useQuery(
    ['daoProfileInfo', chainId, dao],
    () => getDaoInfo(chainId, dao),
    {
      enabled: !!chainId && !!dao,
    },
  )
  ...
  return (
    <Card padding="6">
      {isLoading ? (
        ...
        <Stack align="center">
          <Avatar src="" label="dao profile pic" address={dao as string} size="32" />
          <Heading>
