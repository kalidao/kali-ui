...
export default function Services() {
  return (
    <Stack align="center">
      <Heading align="center" responsive transform='capitalize'>Partner Service Providers</Heading>
        ...
        {serviceProviders.map((provider) => (
            ...
            >
              <Stack>
                ...
                <Button as="a" href={provider.link} shape="circle" tone="violet" target="_blank" rel="noreferrer nooppenner"><IconArrowRight /></Button>
                </Stack>
              </Stack>
            </Card>
        ))}
