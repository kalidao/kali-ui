...
export default function ChooseType({ details, setDetails, handleNext }) {
  const handleClick = (id) => {
    ...
    if (id === 1) {
      ...
      details['extensions']['crowdsale']['purchaseToken'] = presets[id]['extensions']['crowdsale']['purchaseToken']
      details['extensions']['crowdsale']['purchaseMultiplier'] =
        presets[id]['extensions']['crowdsale']['purchaseMultiplier']
      details['extensions']['crowdsale']['purchaseLimit'] = presets[id]['extensions']['crowdsale']['purchaseLimit']
      details['extensions']['crowdsale']['saleEnds'] = presets[id]['extensions']['crowdsale']['saleEnds']
      details['extensions']['crowdsale']['listId'] = presets[id]['extensions']['crowdsale']['listId']
    }
  ...
  const DashedDivider = () => {
    return <Divider orientation="horizontal" variant="dashed" borderColor="white" mt={1} mb={5} />
  }
