...
export default function CreateEntity({ details, setDetails, handleNext }) {
  ...
  return (
    <>
      ...
      options[selected].template != "none" ? (
        <>
          <HStack>
      ...
      {options[selected] != undefined && options[selected].mission != false ? (
        <>
          ...
          <HStack>
            <Text>
              <b>
                Add a link to a document or website which states your DAO's
                mission.
              </b>
            </Text>
            <InfoTip
      ...
      {options[selected] != undefined && options[selected].email != false ? (
        <>
          ...
          <Text>
            Please provide your email address so we can follow up with you on
            next steps.
          </Text>
