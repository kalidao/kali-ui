    ...
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.numbered_list}>
          ...
          <Br />
          <Br />
          1.10 Blockchain-Based Governance Mechanisms.
          <Br />
          <Br />
          ...
          key address on the Designated Blockchain Network that is uniquely
          associated with a single private key, and at which no smart contract
          has been deployed.
          <Br />
          <Br />
          (ix) “Designated Smart Contract” means a “smart contract” (as such
          term is commonly understood and used by software engineers expert in
          developing software for use on the Designated Blockchain Network) that
          ...
          Designated Client on the Designated Blockchain Network. The initial
          ...
          <Br />
          <Br />
          (xii) “Order” means any restraining order, preliminary or permanent
          ...
          <Br />
          <Br />
          (xiii) “Legal Proceeding” means any private or governmental action,
          ...
          <Br />
          <Br />
          (xiv) “Legal Requirement” means any federal, state, local, municipal,
          ...
          <Br />
          <Br />
          (xv) “Liability” means any debt, obligation, duty or liability of any
          ...
          <Br />
          <Br />
          (xvi) “Lien” means any lien, pledge, hypothecation, charge, mortgage,
          ...
          <Br />
          <Br />
          (xvii) A “Material Adverse Exception Event” on a Designated Smart
          ...
          <Br />
          <Br />
          (xviii) “Order” means any: (A) order, judgment, temporary restraining
          ...
          <Br />
          <Br />
          (xix) “Org Property” means any Token or other asset, right or property
          ...
          <Br />
          <Br />
          (xx) “Person” means: (A) any human being/individual/natural person,
          Entity or Governmental Body; and (B) any other thing recognized as a
          legal person under applicable Legal Requirements.
          <Br />
          <Br />
          (xxi) “Token” means a digital unit that is recognized by the
          Designated Blockchain Client on the Designated Blockchain Network as
          capable of: (A) being uniquely associated with or “owned” by a
          particular public-key address on the Designated Blockchain Network at
        ...
        <Text style={styles.numbered_list}>
          ...
          admission of Members shall be the approval by the Members of an
          Ordinary Proposal for the admission of such Person as a Member made
          ...
          of such Person would be making pursuant to Section 2.4.
          <Br />
          <Br />
          ...
          Person or the Org is subject;
          <Br />
          <Br />
          (iii) result in any breach of or constitute a default (or an event
          that with notice or lapse of time or both would become a default)
          under, or impair the rights of the Representing Person or alter the
          rights or obligations of any Person under, or give to any Person any
        ...
        <Text style={styles.numbered_list}>
          ...
          Client, the Designated Blockchain Network, or any Designated Smart
          Contract or Designated Smart Contract Source Code;
          <Br />
          <Br />
          ...
          the Designated Blockchain Network Account Address of the Member
          sponsoring the Proposal, the Designated Blockchain Network Account
          ...
          <Br />
          <Br />
          (i) with respect to an Ordinary Proposal or Exit Proposal, approved by
          affirmative vote of at least a simple majority of the Shares that in
          fact are voted upon such Proposal during the Voting Period for such
          Proposal;
          <Br />
          <Br />
          (ii) with respect to an Extraordinary Proposal, approved by
          affirmative vote of the holders at least 2/3rds of the Shares that are
          issued and outstanding during the Voting Period for such Proposal; or
          <Br />
          <Br />
          (iii) with respect to a Liquidation Proposal, approved by affirmative
          vote of the holders of at least 90% of the Shares that are issued and
          outstanding during the Voting Period for such Proposal.
          <Br />
          <Br />
          ...
          Designated Blockchain Network, provided that the keccak256 hash of
          such information is included in the details field and the information
          remains continuously available to and accessible by all Members in
          unaltered form at all times from the time of the submission of the
          Proposal.
          <Br />
          <Br />
          ...
          Member may the vote the Shares held by such Member on any Proposal
          ...
          Designated Blockchain. 4.5 Alternative Voting Mechanics in Material
          Adverse Exception Event. If there is a Material Adverse Exception
          ...
          of Shares to be redeemed by the Org. A successful call in this manner
          ...
          Contract at the time of the RageQuti; and
          <Br />
          <Br />
          ...
          Percentage of such other Org Property; provided, however, that this
          ...
          to which such Member or former Member is so entitled to such Member or
          former Member by transferring such Tokens to the account of the
          ...
          in and to such Tokens to such Member or former Member, regardless of
          ...
          <Br />
          <Br />
          (v) The allocation of the Tokens and other Org Property to a
          ...
          Interests and Shares, equal to or greater than the fair market value
          ...
          TRANSFER OF THE TOKENS ARE AUTONOMOUS PERSISTENT SCRIPTS RUNNING
          PERMISSIONLESSLY AND FOR ALL PRACTICAL PURPOSES UNALTERABLY ON THE
          DESIGNATED BLOCKCHAIN NETWORK AND ARE NOT UNDER THE CONTROL OF THE
          MEMBERS OR THE ORG. ACCORDINGLY, THE MEMBERS HEREBY ACKNOWLEDGE AND
          AGREE THAT THE ABILITY OF A MEMBER TO RECEIVE OR WITHDRAW TOKENS
          ...
          receive or withdraw from Designated Governance Smart Contract the
          Tokens allocated to such Member or to collect or otherwise receive
          ...
          conflict or interest or otherwise, on a Member voting or refraining
          ...
          all of the GuildKicked Member’s Shares shall be redeemed by the Org,
          mutatis mutandis.
          <Br />
          <Br />
          ...
          approximately, as nearly as reasonably practicable under the
          ...
          be GuildKicked with the result that all Tokens under the control of
          ...
          <Br />
          <Br />
          (c) None of the provisions of this Agreement is intended to provide
      ...
      <Page style={styles.body}>
        ...
        <Text style={styles.numbered_list}>
          ...
          Agreement, if the Membership Proposal for the Candidate is approved by
          the Members, the Candidate will become a Member of the Org and will
          receive Shares or other interests, as applicable; and
          <Br />
          <Br />
          ...
          Candidate’s Membership Proposal resulting in the Candidate becoming
