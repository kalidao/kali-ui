    ...
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.numbered_list}>
          ...
          (c)
          <Tab />
          Seller is the sole beneficial and record holder of the Membership Interests, and upon consummation of the
          transactions contemplated by this Agreement, Seller shall have transferred to Buyer and Buyer shall have
