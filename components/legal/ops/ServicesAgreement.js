  ...
  return (
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.heading3}>BACKGROUND:</Text>
        ...
        <Text style={styles.text}>
          ...
          the matters described above and of the mutual benefits and obligations set forth in this Agreement,
          the receipt and sufficiency of which consideration is hereby acknowledged, the Customer and the Service Provider
          (individually the
          “<Text style={{ textDecoration: "underline" }}>Party</Text>” and collectively the
          “<Text style={{ textDecoration: "underline" }}>Parties</Text>” to this Agreement) agree as follows:
        </Text>


        <Text style={styles.heading3}>Services Provided</Text>
        ...
        <Text style={styles.heading3}>Term of Agreement</Text>

        <Text style={styles.numbered_list}>
          3.
          <Tab />
          The term of this Agreement
          (the “<Text style={{ textDecoration: "underline" }}>Term</Text>”) will begin on the date of this Agreement and will remain in full force and effect indefinitely until terminated as provided in this Agreement.
          <Br />
          4.
          <Tab />
        ...
        <Text style={styles.heading3}>Currency</Text>
        ...
        <Text style={styles.heading3}>Compensation</Text>

        <Text style={styles.numbered_list}>
          8.
          <Tab />
          For the services rendered by the Service Provider as required by this Agreement,
          the Customer will provide compensation
          (the “<Text style={{ textDecoration: "underline" }}>Compensation</Text>”) to the Service Provider as follows:
          <Br />
          <Tab />
          <Tab />
        ...
        <Text style={styles.heading3}>Reimbursement of Expenses</Text>
        ...
        <Text style={styles.numbered_list}>
          ...
          13.
          <Tab />
          The Service Provider agrees that they will not disclose, divulge, reveal, report or use, for any purpose, any Confidential Information which the Service Provider has obtained, except as authorized by the Customer. This obligation will survive indefinitely upon termination of this Agreement.
          <Br />
          14.
          <Tab />
          All written and oral information and material disclosed or provided by the Customer to the Service Provider under this Agreement is Confidential Information regardless of whether it was provided before or after the date of this Agreement or how it was provided to the Service Provider.
          <Br />
        </Text>


        <Text style={styles.heading3}>Return of Property</Text>
        ...
        <Text style={styles.heading3}>Capacity/Independent Contractor</Text>
        ...
        <Text style={styles.heading3}>Notice</Text>
        ...
        <Text style={styles.heading3}>Dispute Resolution</Text>
        ...
        <Text style={styles.heading3}>Modification of Agreement</Text>
        ...
        <Text style={styles.heading3}>Time of the Essence</Text>
        ...
        <Text style={styles.heading3}>Assignment</Text>
        ...
        <Text style={styles.heading3}>Entire Agreement</Text>
        ...
        <Text style={styles.heading3}>Enurement</Text>
        ...
        <Text style={styles.heading3}>Titles/Headings</Text>
        ...
        <Text style={styles.heading3}>Governing Law</Text>
        ...
        <Text style={styles.heading3}>Severability</Text>
        ...
        <Text style={styles.heading3}>Waiver</Text>
        ...
        <Text style={styles.text}>
          <Text style={{ textDecoration: "underline" }}>IN WITNESS WHEREOF</Text>
          the Parties have duly affixed their signatures under hand and seal on this {date}.
        </Text>

        <Text style={styles.heading3}>SIGNED, SEALED, AND DELIVERED</Text>
