    ...
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.numbered_list}>
          ...
          in this Operating Agreement (this “Agreement”) and pursuant to Chapter 29 
          of the Wyoming Limited Liability Company Act (the "Act"). 
          The Members agree to file with the appropriate agencies
          within the State of Wyoming charged with processing and maintaining
          ...
          for which an LLC may be formed within the State of Wyoming.
          <Br />
          <Br />
          1.4
          <Tab />
          ...
          in the State of Wyoming as required by the Act. The DAO LLC has no fixed offices or place of
