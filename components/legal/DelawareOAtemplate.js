    ...
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.text}>
          THIS OPERATING AGREEMENT (this “Agreement”) is made and entered into effective as of the date of the organizing
          ...
          or as added from time to time by the terms of this Agreement (collectively referred to as the “Members”).
          It is the express intention of the Members that this Agreement shall be the sole statement of agreement among the Members.
        </Text>
        ...
        <Text style={styles.numbered_list}>
          ...
          in this Agreement and pursuant to the
