...
import { Text, HStack, VStack, Textarea, Input, Center } from '@chakra-ui/react'
  ...
  return (
    <form onSubmit={submitProposal}>
      <VStack alignItems="left" spacing={2}>
        ...
        <Text>
          <i>
            This is a proposal to <b>{dao['token']['paused'] == true ? 'unpause' : 'pause'}</b> share transferability.
          </i>
        </Text>
