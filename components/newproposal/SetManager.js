...
export default function SetManager() {
  ...
  const { web3, loading, account, abi, address, chainId, dao, daoChain } =
    value.state;
  ...
  return (
    <form onSubmit={handleSubmit(submitProposal)}>
      <VStack w={"100%"}>
        <HStack w="100%">
          <Text>
            Add managers to mint/burn DAO tokens directly without proposal
          </Text>
          <Spacer />
          <Button
            border="0px"
