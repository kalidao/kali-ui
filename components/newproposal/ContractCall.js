...
export default function ContractCall() {
  ...
  const submitProposal = async (event) => {
    ...
    try {
      ...
      var { proposalType_, description_, account_, amount_, abi_, functionName, inputParams, inputs } = array // this must contain any inputs from custom forms
  ...
  return (
    <form onSubmit={submitProposal}>
      <VStack alignItems="left">
        ...
        <Center>
          <Button className="solid-btn" onClick={parseABI}>
            Parse ABI
          </Button>
        </Center>
        {functions == null ? null : (
