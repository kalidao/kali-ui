...
export default function SetRedemption() {
  ...
  const submitProposal = async (event) => {
    ...
    try {
      ...
      if ('redemption' in dao['extensions'] != null && dao['extensions']['redemption'] == null) {
      ...
      const payload_ = web3.eth.abi.encodeParameters(['address[]', 'uint256'], [tokenArray, redemptionStart_])
